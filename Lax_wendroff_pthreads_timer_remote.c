...
#define N   12
#define AVE 8*9*5*7*5/N //2 to 12 except 11 but use around 13GB
#define X AVE*N+1
#define Y AVE*N+1
#define Z 50
...
void main()
{
	...
	names[7] = names8;
  char names9[] = { "wave_data_lax_wendroff_t8.txt" };
  names[8] = names9;
  char names10[] = { "wave_data_lax_wendroff_t8.txt" };
  names[9] = names10;
  char names11[] = { "wave_data_lax_wendroff_t8.txt" };
  names[10] = names11;
  char names12[] = { "wave_data_lax_wendroff_t8.txt" };
  names[11] = names12;
